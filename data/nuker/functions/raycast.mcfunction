...
execute positioned ^ ^ ^0.1 rotated ~ ~ unless block ~ ~ ~ #nuker:raycast_pass run function nuker:block_collide 

scoreboard players add .distance rc 1

# Make raycast visible
particle minecraft:shriek 0 ~ ~ ~ 0 0 0 0 0 force
...
execute if score .distance rc matches ..2000 positioned ^ ^ ^0.1 rotated ~ ~ if block ~ ~ ~ #nuker:raycast_pass run function nuker:raycast
